...
export const captionTemplates = {
  ...
  supplier: [
    { text: "Another 40-foot container just cleared customs and our warehouse team is buzzing. Premium harnesses, biodegradable waste bags, and orthopedic beds — all tested, certified, and ready to ship to your store by next week. We handle the logistics so you can focus on what you do best: serving pet parents. DM us for our updated wholesale catalog.", hashtags: "#PetSupplier #WholesalePets #PetDistributor #PetIndustry #PetRetail #BulkPetProducts", imageIdea: "Warehouse shelves stocked with pet products, organized and branded packaging visible", videoIdea: "Warehouse walkthrough video showing product lines, quality checks, and packaging — professional B2B content", engagementHook: { type: "save", prompt: "Save this — new catalog drops every quarter!", saveable: true, saveReason: "Wholesale catalog update" }, category: "promo", photo: "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=600&h=600&fit=crop" },
    { text: "Your retail shelves should tell a story, not just hold products. We help pet stores curate collections that actually move — seasonal bundles, themed endcaps, and trending products before they trend. Our data shows stores using curated displays see 35% higher basket sizes. Let us help you merchandise smarter. Book a free consultation.", hashtags: "#PetRetail #Merchandising #PetBusiness #RetailStrategy #PetIndustry #StoreDesign", imageIdea: "Beautifully merchandised pet store display with curated products and clear signage", videoIdea: "Before/after retail display transformation — show the impact of strategic merchandising", engagementHook: { type: "comment", prompt: "What's your best-selling product this month? Drop it below!", saveable: false }, category: "educational", photo: "https://images.unsplash.com/photo-1583511655857-d19b40a7a54e?w=600&h=600&fit=crop" },
    { text: "We just got back from SuperZoo and here's what's coming: sustainable packaging is no longer optional, functional treats are exploding, and tech-enabled products are the fastest growing category. If your store isn't stocking these trends, you're leaving money on the table. We're already sourcing the best options for our partners. Want in? Link in bio.", hashtags: "#PetIndustry #SuperZoo #PetTrends #WholesalePets #PetDistributor #RetailTrends", imageIdea: "Trade show booth or trend report infographic with key product categories highlighted", videoIdea: "Quick recap video from the trade show floor — show trending products and share insights", engagementHook: { type: "save", prompt: "Save this trend report — share it with your buying team!", saveable: true, saveReason: "Pet industry trends" }, category: "educational", photo: "https://images.unsplash.com/photo-1556761175-5973dc0f32e7?w=600&h=600&fit=crop" },
    { text: "Reliable supply chain. Consistent quality. Competitive margins. That's what we promise every retail partner, and that's what we deliver — 98.7% on-time delivery rate last quarter. We know your business depends on having the right products at the right time. No stockouts, no surprises, no excuses. That's the standard we hold ourselves to.", hashtags: "#PetSupplier #SupplyChain #PetDistributor #ReliablePartner #PetIndustry #B2B", imageIdea: "Professional logistics photo — delivery truck, warehouse operations, quality check process", videoIdea: "Behind-the-scenes of your fulfillment process — from order to delivery, showing reliability", engagementHook: { type: "share", prompt: "Tag a pet retailer who deserves a reliable supplier!", saveable: false }, category: "trust", photo: "https://images.unsplash.com/photo-1553413077-190dd305871c?w=600&h=600&fit=crop" },
    { text: "Launching a new pet store? We've helped 200+ retailers go from empty shelves to grand opening in under 30 days. Our startup program includes curated inventory selection, merchandising support, POS integration, and flexible payment terms. You bring the passion for pets — we bring everything else. Schedule your free strategy call today.", hashtags: "#PetRetail #NewBusiness #PetStore #PetDistributor #StartupSupport #PetIndustry", imageIdea: "Grand opening ribbon cutting at a pet store, or split of empty shelves vs fully stocked store", videoIdea: "Timelapse of a store going from empty to fully stocked and ready for opening day", engagementHook: { type: "comment", prompt: "Opening a pet store? Drop your city — we might be in your area!", saveable: true, saveReason: "Startup program info" }, category: "brand", photo: "https://images.unsplash.com/photo-1556761175-b413da4baf72?w=600&h=600&fit=crop" },
  ],
  food_brand: [
    { text: "Every batch starts the same way: with ingredients we'd feed our own dogs. Real chicken as the #1 ingredient. Sweet potatoes from family farms. Blueberries packed with antioxidants. No corn, no wheat, no soy, no artificial anything. We believe pet food should be simple, honest, and nutritious. Read our label — you'll actually recognize everything on it.", hashtags: "#PetFood #DogFood #NaturalPetFood #CleanLabel #PetNutrition #RealIngredients", imageIdea: "Beautiful flat lay of raw ingredients next to the finished product — transparency and quality", videoIdea: "Ingredient journey video: show each ingredient from farm/source to the final product — clean, premium feel", engagementHook: { type: "save", prompt: "Save this — check YOUR dog's food label tonight!", saveable: true, saveReason: "Clean ingredient checklist" }, category: "trust", photo: "https://images.unsplash.com/photo-1589924691995-400dc9ecc119?w=600&h=600&fit=crop" },
    { text: "Meet Max. Six months ago his coat was dull, his energy was low, and his stomach was a mess. His vet suggested switching food. His owner found us. Today? Shiny coat, endless energy, and perfect digestion. We're not saying we're miracle workers... but Max's owner did say 'it's like we got a new dog.' Real results. Real food. Real difference.", hashtags: "#PetFood #DogFoodReview #PetTransformation #HealthyDog #DogNutrition #BeforeAndAfter", imageIdea: "Before/after photos of a dog showing coat and energy improvement — owner testimonial", videoIdea: "Customer testimonial video: owner shares their dog's transformation story with before/after footage", engagementHook: { type: "share", prompt: "Know a dog that deserves better food? Share this with their owner!", saveable: false }, category: "testimonial", photo: "https://images.unsplash.com/photo-1587300003388-59208cc962cb?w=600&h=600&fit=crop" },
    { text: "We spent 18 months developing our new Senior Formula with veterinary nutritionists. Joint support from glucosamine and chondroitin. Brain health from omega-3 DHA. Easy digestion from prebiotics and probiotics. Because senior dogs don't just need food — they need nutrition designed for their changing bodies. Available now at select retailers and online.", hashtags: "#SeniorDog #PetFood #DogNutrition #PetBrand #SeniorPetCare #VetApproved", imageIdea: "Senior dog looking healthy and happy with the product beside them — warm, dignified imagery", videoIdea: "Product launch video: explain the science behind each ingredient, show senior dogs thriving", engagementHook: { type: "save", prompt: "Got a senior dog? Save this — nutrition matters even more as they age!", saveable: true, saveReason: "Senior dog nutrition guide" }, category: "educational", photo: "https://images.unsplash.com/photo-1534361960057-19889db9621e?w=600&h=600&fit=crop" },
    { text: "The pet food industry doesn't always make it easy to know what you're feeding your dog. That's why we publish our full ingredient sourcing, nutritional testing results, and manufacturing process right on our website. No hiding behind vague labels. No 'proprietary blends.' Full transparency, because your dog's health isn't something we play games with.", hashtags: "#PetFood #Transparency #DogFood #PetBrand #CleanLabel #PetParentTrust", imageIdea: "Infographic showing the journey from ingredient sourcing to the finished bag on store shelves", videoIdea: "Factory tour video: show the entire production process — sourcing, testing, manufacturing, packaging", engagementHook: { type: "comment", prompt: "What's ONE thing you wish pet food brands were more honest about?", saveable: false }, category: "brand", photo: "https://images.unsplash.com/photo-1585846416120-3a7354ed7d39?w=600&h=600&fit=crop" },
    { text: "Retailer spotlight! Shoutout to Paws & Claws Pet Supply for being one of our original partners and for consistently going above and beyond educating pet parents about nutrition. Stores like this are the reason we do what we do. If you're a retailer who shares our passion for quality pet nutrition, let's talk. We're expanding our retail network.", hashtags: "#PetFood #RetailPartner #PetBrand #PetStore #Partnership #PetIndustry", imageIdea: "Photo of the featured retail partner's store with your products on display — genuine partnership feel", videoIdea: "Visit a retail partner: show the store, interview the owner about why they chose your brand", engagementHook: { type: "share", prompt: "Tag a pet store that deserves a shoutout!", saveable: false }, category: "brand", photo: "https://images.unsplash.com/photo-1583511655857-d19b40a7a54e?w=600&h=600&fit=crop" },
  ],
  wholesale: [
    { text: "Direct from manufacturer to your shelf — no middlemen, no markups, no delays. We import premium pet products from certified facilities in 12 countries and deliver them to your door with full regulatory compliance. Every product comes with safety certifications, lab testing results, and competitive margins that keep your business profitable.", hashtags: "#PetImporter #WholesalePets #PetProducts #ImportExport #PetIndustry #B2B", imageIdea: "Shipping container being unloaded, products on pallets, professional import operation", videoIdea: "Import journey video: show products from factory overseas to your warehouse to retail shelves", engagementHook: { type: "save", prompt: "Save this — request our product catalog today!", saveable: true, saveReason: "Import product catalog" }, category: "promo", photo: "https://images.unsplash.com/photo-1578575437130-527eed3abbec?w=600&h=600&fit=crop" },
    { text: "Regulatory compliance isn't sexy, but it's everything. Every product we import meets AAFCO standards, passes CFIA inspection, and comes with complete documentation. We've seen competitors cut corners on compliance and lose entire shipments at the border. We don't gamble with your inventory. Every container we clear is a container you can sell with confidence.", hashtags: "#PetImporter #Compliance #PetIndustry #AAFCO #QualityControl #PetSafety", imageIdea: "Quality control documentation, inspection certificates, lab testing — professional and trustworthy", videoIdea: "Explainer video: walk through your compliance process step-by-step, showing why it matters", engagementHook: { type: "share", prompt: "Share this with anyone importing pet products — compliance matters!", saveable: true, saveReason: "Import compliance checklist" }, category: "trust", photo: "https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=600&h=600&fit=crop" },
    { text: "Minimum order quantities that actually make sense for small and mid-size retailers. We know not every pet store can commit to 500-unit minimums. That's why we offer flexible MOQs starting at just 50 units on most product lines. Small business friendly. Big business quality. That's our promise to independent retailers across the country.", hashtags: "#WholesalePets #SmallBusiness #PetRetail #FlexibleMOQ #PetDistributor #IndependentRetail", imageIdea: "Variety of box sizes being packed — showing flexibility from small to large orders", videoIdea: "Quick comparison: show what 50 units vs 500 units looks like — make small retailers feel welcome", engagementHook: { type: "comment", prompt: "What's the biggest barrier to stocking new products? Drop it below!", saveable: false }, category: "brand", photo: "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=600&h=600&fit=crop" },
    { text: "This week's container highlights: 🦴 Premium bully sticks — 100% grass-fed, single ingredient. 🧸 Plush toys with double-stitched seams rated for aggressive chewers. 🛏️ Memory foam beds with removable, washable covers. All in stock, all ready to ship, all with margins that make your accountant smile. Request pricing: link in bio.", hashtags: "#WholesalePets #PetProducts #PetImporter #BulkPetProducts #PetRetail #NewStock", imageIdea: "Product lineup photo: all featured items arranged professionally with pricing tags", videoIdea: "New arrival showcase: unbox and demonstrate each product, highlighting quality and retail appeal", engagementHook: { type: "save", prompt: "Save this — these sell fast and restock takes 6-8 weeks!", saveable: true, saveReason: "New stock notification" }, category: "promo", photo: "https://images.unsplash.com/photo-1583337130417-13104dec14c3?w=600&h=600&fit=crop" },
    { text: "Our partners don't just buy products from us — they get a growth partner. Free merchandising advice. Quarterly trend reports. Marketing materials you can co-brand. And a dedicated account manager who answers on the first ring. We succeed when you succeed. That's not a tagline, it's our business model. Become a partner today.", hashtags: "#PetDistributor #PetIndustry #RetailPartner #WholesalePets #BusinessGrowth #B2B", imageIdea: "Business meeting or handshake photo — professional partnership imagery", videoIdea: "Partner testimonial compilation: retailers share how the partnership helped their business grow", engagementHook: { type: "comment", prompt: "What's the ONE thing you look for in a wholesale partner?", saveable: false }, category: "brand", photo: "https://images.unsplash.com/photo-1556761175-b413da4baf72?w=600&h=600&fit=crop" },
  ],
  insurance: [
    { text: "A golden retriever tore their ACL chasing a squirrel last Tuesday. Surgery: $4,800. Recovery: 12 weeks. The owner's out-of-pocket cost with our plan? $480. That's it. One accident can cost more than a lifetime of premiums. Pet insurance isn't about IF something happens — it's about being ready WHEN it does. Get a free quote in 60 seconds.", hashtags: "#PetInsurance #DogInsurance #PetHealth #VetBills #PetProtection #PetParent", imageIdea: "Happy dog with bandaged leg recovering — optimistic tone, not scary", videoIdea: "Real claim story: show the timeline from accident to surgery to recovery, ending with 'total cost: $480'", engagementHook: { type: "save", prompt: "Save this — you'll be glad you did when the unexpected happens!", saveable: true, saveReason: "Pet insurance info" }, category: "educational", photo: "https://images.unsplash.com/photo-1587300003388-59208cc962cb?w=600&h=600&fit=crop" },
    { text: "Hot take: the best time to get pet insurance was the day you brought your pet home. The second best time is today. Why? Because premiums are lower when your pet is young and healthy. Pre-existing conditions aren't covered by any provider. And accidents don't schedule themselves. Don't wait for the emergency room to wish you had coverage.", hashtags: "#PetInsurance #PetHealth #PetProtection #InsuranceTips #PetParenting #PetCare", imageIdea: "Puppy or kitten looking adorable — 'the best time to insure is now' overlay text", videoIdea: "Quick explainer: why insuring young pets saves money — use simple graphics and a friendly tone", engagementHook: { type: "share", prompt: "Share this with a new pet parent — they'll thank you later!", saveable: true, saveReason: "When to get pet insurance" }, category: "educational", photo: "https://images.unsplash.com/photo-1548199973-03cce0bbc87b?w=600&h=600&fit=crop" },
    { text: "We just made filing a claim even easier. Snap a photo of your vet invoice. Upload it in our app. Get reimbursed in as little as 3 business days. No faxing. No mailing. No calling and waiting on hold for 45 minutes. Because when your pet needs care, the last thing you should worry about is paperwork.", hashtags: "#PetInsurance #EasyClaims #PetApp #PetHealth #PetProtection #ModernInsurance", imageIdea: "Phone screen showing the claims app with a simple upload interface — clean and modern", videoIdea: "Screen recording walkthrough: show how easy it is to file a claim in under 2 minutes", engagementHook: { type: "save", prompt: "Save this for when you need to file a claim — it's that easy!", saveable: true, saveReason: "How to file a pet insurance claim" }, category: "promo", photo: "https://images.unsplash.com/photo-1512438248247-f0f2a5a8b7f0?w=600&h=600&fit=crop" },
    { text: "Let's clear up the biggest pet insurance myths. Myth: 'It's too expensive.' Reality: plans start at $1/day. Myth: 'They never pay out.' Reality: we paid $12M in claims last year. Myth: 'My pet is healthy, I don't need it.' Reality: 1 in 3 pets need emergency vet care every year. Knowledge is power. Get a free quote and see for yourself.", hashtags: "#PetInsurance #PetMyths #PetHealth #InsuranceFacts #PetCare #VetCare", imageIdea: "Myth vs Reality infographic — clean, easy to read, brand colors", videoIdea: "Myth-busting video: address each myth on screen with data to back up the reality", engagementHook: { type: "comment", prompt: "What's YOUR biggest question about pet insurance? Ask below!", saveable: false }, category: "trust", photo: "https://images.unsplash.com/photo-1574158622682-e40e69881006?w=600&h=600&fit=crop" },
    { text: "We partner with veterinary clinics across the country because we share the same goal: making quality pet healthcare accessible to every family. Vets recommend us because we pay claims fast, cover comprehensive care, and never put pet parents in a position where they have to choose between their pet's health and their budget. That's a line no one should ever have to walk.", hashtags: "#PetInsurance #VetPartner #PetHealth #AnimalHospital #PetCare #VetRecommended", imageIdea: "Veterinarian with a pet and owner — warm, professional, trust-building", videoIdea: "Vet testimonial: a partner vet explains why they recommend your insurance to clients", engagementHook: { type: "share", prompt: "Tag your vet — do they partner with pet insurance providers?", saveable: false }, category: "brand", photo: "https://images.unsplash.com/photo-1628009368231-7bb7cfcb0def?w=600&h=600&fit=crop" },
  ],
  education: [
    { text: "You love dogs. You want to work with dogs. But you don't know where to start. Sound familiar? Our certification program takes you from zero to certified professional in 12 weeks — with hands-on training, mentorship, and job placement support. 94% of our graduates land their first pet industry job within 60 days. Your new career starts with one click.", hashtags: "#PetEducation #DogTraining #PetCareer #PetCertification #AnimalCourses #PetIndustry", imageIdea: "Student working hands-on with a dog during training — learning in action", videoIdea: "Student journey video: follow a student from enrollment to certification to first job — inspiring narrative", engagementHook: { type: "save", prompt: "Save this — share it with someone who dreams of working with animals!", saveable: true, saveReason: "Pet career certification info" }, category: "promo", photo: "https://images.unsplash.com/photo-1587300003388-59208cc962cb?w=600&h=600&fit=crop" },
    { text: "This week's free tip from our canine behavior module: dogs don't 'misbehave' to spite you. Every unwanted behavior is communication. Barking? They're alerting or anxious. Chewing? They need stimulation. Pulling on leash? They haven't learned an alternative yet. Once you understand the WHY, the solution becomes obvious. Want to learn more? Our intro course is free.", hashtags: "#DogBehavior #PetEducation #DogTraining #AnimalBehavior #PetCourses #CaninePsychology", imageIdea: "Dog with thought bubble showing what they're 'really saying' — educational but fun", videoIdea: "Quick educational reel: show 3 common 'bad behaviors' and explain what the dog is actually communicating", engagementHook: { type: "comment", prompt: "What's one behavior you wish you understood better? Drop it below!", saveable: true, saveReason: "Dog behavior tips" }, category: "educational", photo: "https://images.unsplash.com/photo-1544568100-847a948585b9?w=600&h=600&fit=crop" },
    { text: "Congratulations to our latest graduating class! 28 newly certified pet professionals ready to make a difference in the industry. From future groomers to dog trainers to pet nutrition specialists — this group brought incredible energy and dedication to every single module. We can't wait to see where your careers take you.", hashtags: "#PetEducation #Graduation #PetCareer #Certified #PetIndustry #ProudMoment", imageIdea: "Group graduation photo with certificates — celebrating achievement", videoIdea: "Graduation highlight reel: clips from training, funny moments, certificate ceremony — emotional and celebratory", engagementHook: { type: "share", prompt: "Know someone who should be in our next class? Tag them!", saveable: false }, category: "milestone", photo: "https://images.unsplash.com/photo-1523050854058-8df90110c476?w=600&h=600&fit=crop" },
    { text: "Pet first aid is a skill every pet professional needs — and most don't have. Do you know how to handle choking, heatstroke, or a seizure? Our Pet First Aid & CPR course is now available online. 4 hours. Lifetime certification. Could literally save a life. Next cohort starts Monday. Early bird pricing ends this Friday.", hashtags: "#PetFirstAid #PetCPR #PetEducation #PetSafety #AnimalCare #PetProfessional", imageIdea: "Pet first aid kit laid out with key supplies — professional and educational", videoIdea: "Demo video: show proper technique for one first aid scenario — valuable, shareable content", engagementHook: { type: "save", prompt: "Save this — every pet professional needs first aid certification!", saveable: true, saveReason: "Pet first aid course" }, category: "educational", photo: "https://images.unsplash.com/photo-1576201836106-db1758fd1c97?w=600&h=600&fit=crop" },
    { text: "We asked 500 pet industry employers: what's the #1 skill they look for when hiring? The answer wasn't technical knowledge. It wasn't certifications. It was communication — the ability to talk to pet parents with empathy, clarity, and confidence. That's why every single one of our courses includes client communication training. Because knowing your stuff is only half the job.", hashtags: "#PetEducation #PetCareer #PetIndustry #SoftSkills #PetProfessional #Communication", imageIdea: "Professional interacting warmly with a pet parent — demonstrating great communication", videoIdea: "Interview industry employers: 'What do you look for in new hires?' — compile answers into a powerful message", engagementHook: { type: "comment", prompt: "What skill do YOU think is most important in the pet industry?", saveable: false }, category: "brand", photo: "https://images.unsplash.com/photo-1556761175-5973dc0f32e7?w=600&h=600&fit=crop" },
  ],
  influencer: [
    { text: "POV: You're trying to take a cute photo of your dog but they keep doing THIS instead. 😂 Honestly, the outtakes are always better than the final shot. Who else has a camera roll that's 90% blurry pet photos and 10% actual content? This is the reality behind every 'perfect' pet photo you see on your feed. The chaos IS the content.", hashtags: "#PetInfluencer #DogsOfInstagram #PetContent #BehindTheScenes #PetCreator #ContentCreator #DogMom #Relatable", imageIdea: "Grid of blurry/funny outtakes next to the one perfect shot that made it to the feed", videoIdea: "Reel: show 10 failed attempts then the final gorgeous photo — trending audio with comedic timing", engagementHook: { type: "comment", prompt: "Show me your best outtake! Drop a 📸 if your camera roll looks like this too!", saveable: false }, category: "fun", photo: "https://images.unsplash.com/photo-1587300003388-59208cc962cb?w=600&h=600&fit=crop" },
    { text: "Things I've learned since becoming a pet influencer: 1. Your pet is the star, not you. Accept it. 2. The algorithm loves consistency more than perfection. 3. Brands want to see engagement, not just followers. 4. The community you build matters more than any sponsorship. 5. Your pet will NEVER cooperate when you have a deadline. This journey has taught me patience, creativity, and that treats are the ultimate currency.", hashtags: "#PetInfluencer #ContentCreatorTips #PetCreator #InfluencerLife #PetCommunity #CreatorEconomy #DogContent", imageIdea: "Casual photo of creator with their pet, authentic behind-the-scenes vibe", videoIdea: "Talking head reel: share each lesson with clips illustrating each point — relatable and valuable for aspiring creators", engagementHook: { type: "save", prompt: "Save this if you're building a pet account — these lessons took me years to learn!", saveable: true, saveReason: "Pet influencer tips" }, category: "educational", photo: "https://images.unsplash.com/photo-1544568100-847a948585b9?w=600&h=600&fit=crop" },
    { text: "Monthly favorites! Here's everything we used and loved this month. Linking everything in stories but honestly? The puzzle feeder was a game-changer. 20 minutes of quiet while I actually get to eat breakfast in peace. If you only try one thing from this list, make it that one. Your sanity will thank you.", hashtags: "#PetInfluencer #MonthlyFavorites #PetProducts #PetReview #DogMom #CatMom #PetRecommendations #Sponsored", imageIdea: "Flat lay of all monthly favorite products with the pet sniffing them — aesthetic and informative", videoIdea: "Quick showcase reel: hold up each product with a one-sentence review — fast-paced, engaging, shoppable", engagementHook: { type: "save", prompt: "Save this for your next pet shopping trip! 🛒", saveable: true, saveReason: "Monthly pet product favorites" }, category: "promo", photo: "https://images.unsplash.com/photo-1583337130417-13104dec14c3?w=600&h=600&fit=crop" },
    { text: "A year ago this account had 200 followers. Today we just hit 10K. Here's what actually moved the needle: posting reels 4-5x per week, engaging with other pet accounts daily for 20 minutes, using trending audio within the first 24 hours, and most importantly — showing our real life, not a highlight reel. Your pet's personality is your superpower. Stop trying to be polished. Be real.", hashtags: "#PetInfluencer #GrowthTips #InstagramGrowth #ContentCreator #10K #PetCreator #SocialMediaTips", imageIdea: "Screenshot of follower milestone with genuine celebration photo", videoIdea: "Growth journey video: show early posts vs now, share specific tips with real examples and analytics screenshots", engagementHook: { type: "share", prompt: "Share this with someone starting their pet account — they need to hear this!", saveable: true, saveReason: "Instagram growth tips for pet accounts" }, category: "milestone", photo: "https://images.unsplash.com/photo-1548199973-03cce0bbc87b?w=600&h=600&fit=crop" },
    { text: "Sunday reset but make it pet parent edition. Fresh water in all the bowls. Toy basket reorganized (for 5 minutes before it's destroyed again). Nails trimmed. New content batch filmed. Treat jar restocked. Weekly weigh-in done. And the most important part? Extra couch cuddles because they've been such a good boy/girl all week. What's on YOUR Sunday pet routine?", hashtags: "#PetInfluencer #SundayReset #PetRoutine #DogMom #CatMom #PetCare #ContentCreator #PetLife", imageIdea: "Aesthetic flat lay or grid showing Sunday reset items — bowls, toys, treats, grooming supplies", videoIdea: "ASMR-style Sunday reset video: satisfying clips of each task with calming music — highly shareable format", engagementHook: { type: "comment", prompt: "What's your Sunday pet routine? Tell me below! 👇", saveable: false }, category: "engagement", photo: "https://images.unsplash.com/photo-1576201836106-db1758fd1c97?w=600&h=600&fit=crop" },
  ],
  other: [
...
export const seoKeywords = {
  ...
  supplier: { primary: ["pet supplier", "pet distributor", "wholesale pet products"], secondary: ["pet product distributor", "bulk pet supplies", "pet retail supplier", "pet wholesale catalog"] },
  food_brand: { primary: ["pet food brand", "dog food manufacturer", "natural pet food"], secondary: ["premium dog food", "healthy pet food", "pet nutrition brand", "clean label pet food"] },
  wholesale: { primary: ["pet product importer", "wholesale pet supplies", "pet wholesale distributor"], secondary: ["bulk pet products", "pet import export", "pet trade", "pet product sourcing"] },
  insurance: { primary: ["pet insurance", "dog insurance", "pet health insurance"], secondary: ["pet insurance plans", "vet bill coverage", "pet accident insurance", "pet insurance quotes"] },
  education: { primary: ["pet education", "pet courses", "animal training certification"], secondary: ["pet professional training", "dog grooming course", "pet career", "animal behavior certification"] },
  influencer: { primary: ["pet influencer", "dog influencer", "pet content creator"], secondary: ["pet instagram", "dog mom life", "pet creator tips", "pet brand collab"] },
